...
export default class Translator {
    options = { user: "default", languaje: { language: 'ENG', resources: [] } };
    ...
    constructor(options = {}) {
        ...
        /**
         * Set the sessionStorage languaje and translate de page.
         * 
         * resources is the json resources object
         * @param {*} args
         */
    setLanguaje = function(args = [{ language: 'ENG', resources: [] }]) {
        localStorage.setItem(this.options.user + "_t_language", args.language);
